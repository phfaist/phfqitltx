...
\usepackage[title=default,pkgset=extended,secfmt={section},hyperrefdefs=true]{phfnote}\usepackage{hyperref}
%\usepackage[title=default,pkgset=extended,secfmt={section},hyperrefdefs=defer]{phfnote}\usepackage{hyperref}
